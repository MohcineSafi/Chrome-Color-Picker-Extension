...
const exportColors = () => {
    ...
    const exportedColorsTextArea = document.getElementById("exported-colors");
    exportedColorsTextArea.value = colorText;
...
const clearAllColors = () => {
    const confirmClear = confirm("Are you sure you want to clear all colors?");
    if (confirmClear) {
        pickedColors = [];
